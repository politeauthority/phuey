...
class Phuey(object):
    ...
    def get_local_config(self, value: str) -> str:
        """
        Utility to get local redis value.
        @todo: should be moved to a generic function the web app and cli tool can use. DRY!
    ...
    def _get_global_or_specific_generic_animation_option(self, option_type, animation: str=''):
        """
        Hopeful generic function to get global OR animation specific redis vals.
        @TODO: NEEDS WORK! but nice idea tho
    ...
    def set_selected_lights(self) -> list:
        """
        Get the lights from a the .phuey/config.json OR a web app value.
        I think ideally this should be 100% web app driven.
        @todo: let this be 100% web app control, ie better UI.
